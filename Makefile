...
SRCS = main.c utils/libft_utils.c utils/libft_utils2.c utils/list_utils.c utils/list_utils2.c utils/free_utils.c utils/error_utils.c utils/ft_itoa.c \
	...
	tokenize/assign_types.c tokenize/tokens_utils.c tokenize/tokens_checker.c tokenize/update_tokens.c debugger/debug_type.c\
	parsing/parsing.c parsing/type_init.c parsing/parse_redirs.c parsing/parse_exec.c run_cmd/run_utils.c tokenize/update_tokens_utils.c\
